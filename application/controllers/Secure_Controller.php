...
class Secure_Controller extends CI_Controller
{
	...
	public function __construct($module_id = NULL, $submodule_id = NULL, $menu_group = NULL)
	{
		...
		if (
			!$model->has_module_grant($module_id, $logged_in_employee_info->person_id) ||
	...
	protected function xss_clean($str, $is_image = FALSE)
	{
		...
		if ($this->config->item('pos_xss_clean') == FALSE) {
			return $str;
		} else {
	...
	// this is the basic set of methods most pos Controllers will implement
