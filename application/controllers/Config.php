...
class Config extends Secure_Controller
{
	...
	/*
	 * This function loads all the licenses starting with the first one being pos one
	 */
	private function _licenses()
	{
		...
		if (file_exists('license/LICENSE')) {
			...
			$license[$i]['text'] = 'LICENSE file must be in pos license directory. You are not allowed to use pos application until the distribution copy of LICENSE file is present.';
		}
	...
	public function save_general()
	{
		...
		if ($batch_save_data['category_dropdown'] == 1) {
			$definition_data['definition_name'] = 'pos_category';
	...
	public function backup_db()
	{
		...
		if ($this->Employee->has_module_grant('config', $employee_id)) {
			...
			$file_name = 'pos-' . date("Y-m-d-H-i-s") . '.zip';
