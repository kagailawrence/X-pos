...
<fieldset id="sale_basic_info">
		...
		<div class="form-group form-group-sm">
			...
			<div class='col-xs-8'>
				<?php if (!empty($sale_info["invoice_number"]) && isset($sale_info['customer_id']) && !empty($sale_info['email'])): ?>
					...
					<a id="send_invoice" href="javascript:void(0);">
						<?php echo $this->lang->line('sales_send_invoice'); ?>
					</a>
				<?php else: ?>
			...
			<div class='col-xs-4'>
				<div class="input-group input-group-sm">
					<?php if (!currency_side()): ?>
						<span class="input-group-addon input-sm"><b>
	...
	foreach ($payments as $row) {
		...
		<div class="form-group form-group-sm">
			...
			<div class='col-xs-4'>
				<?php // no editing of M-pesapayments as it's a complex change  ?>
