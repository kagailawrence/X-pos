	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-8" id="issuetemplate" align="left"><br>
				...
				<?php echo substr($this->config->item('commit_sha1'), 0, 6); ?><br>
				Language Code:
				<?php echo current_language_code(); ?><br><br>
				...
				.DB Version:
				<?php echo mysqli_get_server_info($this->db->conn_id); ?><br>
				.Server Port:
				<?php echo $_SERVER['SERVER_PORT']; ?><br>
				.OS:
				<?php echo php_uname('s') . ' ' . php_uname('r'); ?><br><br>
				File Permissions:<br>
				&#187; [application/logs:]
				...
				if (
					!((substr(decoct(fileperms($logs)), -4) == 750) && (substr(decoct(fileperms($uploads)), -4) == 750) && (substr(decoct(fileperms($images)), -4) == 750)
				...
				<div id="ostimezone" style="display:none;">
					<?php echo $this->config->item('timezone'); ?>
				</div><br>
				<br>
			</div>
		</div>
