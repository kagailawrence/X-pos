...
RENAME TABLE `pos_tax_codes` TO `pos_tax_codes_backup`;
...
RENAME TABLE `pos_sales_taxes` TO `pos_sales_taxes_backup`;
...
CREATE TABLE IF NOT EXISTS `pos_tax_jurisdictions` (
...
RENAME TABLE `pos_tax_code_rates` TO `pos_tax_code_rates_backup`;
