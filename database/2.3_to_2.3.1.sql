...
INSERT INTO `pos_permissions` (permission_id, module_id, location_id) 
(SELECT CONCAT('items_', location_name), 'items', location_id FROM pos_stock_locations);
...
-- add record_time column to pos_giftcards table
ALTER TABLE pos_giftcards ADD record_time timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP;
