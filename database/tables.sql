...
INSERT INTO `pos_employees` (`username`, `password`, `person_id`, `deleted`, `hash_version`) VALUES
...
INSERT INTO `pos_stock_locations` (`location_name` ) VALUES ('stock');
...
INSERT INTO `pos_dinner_tables` (`name`) VALUES ('Delivery'), ('Take Away');
...
INSERT INTO `pos_customers_packages` (`package_name`, `points_percent`) VALUES
  ('Default', 0),
  ('Bronze', 10),
  ('Silver', 20),
  ('Gold', 30),
